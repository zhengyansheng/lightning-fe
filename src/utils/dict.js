...
export const sqlTypeOptions = [{
    key: 'DML',
    display_name: 'DML:操作表数据'
  },
  {
    key: 'DDL',
    display_name: 'DDL:操作表结构'
  }
]
...
export const reviewAOptions = [{
    key: 1,
    display_name: '同意,自动执行'
  },
  {
    key: 2,
    display_name: '同意，已手动执行完成'
  },
  {
    key: 0,
    display_name: '驳回'
...
export const colorOptions = [{
    key: '1',
    display_name: '255, 0, 0'
  },
  {
    key: '0',
    display_name: '255, 165, 0'
  }
]
