<template>
  ...
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column :label="'属性规则'">
        <template slot-scope="scope">
          <span>{{ scope.row.props }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="'高级校验规则'">
        <template slot-scope="scope">
          <span>{{ scope.row.validate|isValidateRequiredFilter }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="'数据选项'">
        <template slot-scope="scope">
          <span>{{ scope.row.options }}</span>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" :close-on-click-modal='false'>
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left"
        ...
        <el-form-item :label="'模板'" prop="demoid">
        ...
        <el-form-item :label="'属性规则'" prop="props">
        ...
        <el-form-item :label="'是否必填'" prop="validate_required">
          <el-switch
        ...
        <el-form-item :label="'数据获取接口'" prop="dicurl">
          <el-input v-model="temp.dicurl"/>
        </el-form-item>

        <el-form-item :label="'数据选项'" prop="options">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button v-show="dialogStatus!='detail'" type="primary"
                   @click="dialogStatus==='create'?createData():updateData()" size="mini" v-no-more-click>确认
        </el-button>
      </div>
    </el-dialog>
